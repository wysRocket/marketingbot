var API = (function(){
  ...
  var getCompetitorUrlKeywords = function(params, cbProcessResponse){
    var url = 'https://data.keywordseverywhere.com/service/get-competitor-url-keywords';
    var country = params.country;
    if (!country) country = 'us';
    ajax({
      method: 'POST',
  ...
  var getMatchingUrls = function(params, cbProcessResponse){
    var url = 'https://data.keywordseverywhere.com/service/get-matching-urls';
    var country = params.country;
    if (!country) country = 'us';
    ajax({
      method: 'POST',
  ...
  async function openAIFetchCategories(source) {
  ...
  async function openAIFetchTemplates(subcat, source) {
  ...
  async function openAIFetchTemplate(id, source) {
  ...
  async function openAIFetchSEOReports(source) {
    const url = new URL(API_URL + `templates/getSEOReports.php`);
    if (source) {
      url.searchParams.set('source', source);
    }
    const response = await fetch(url);
  ...
  async function openAIFetchSEOReport(id, source) {
    const url = new URL(API_URL + `templates/getSEOReport.php`);
    url.searchParams.set('id', id);
    if (source) {
      url.searchParams.set('source', source);
    }
  ...
  async function openAIFetchKEPrompt(id, source) {
    const url = new URL(API_URL + `templates/getKEPrompt.php`);
    url.searchParams.set('id', id);
    if (source) {
      url.searchParams.set('source', source);
    }
  ...
  return {
    ...
    getCompetitorUrlKeywords: getCompetitorUrlKeywords,
    getMatchingDomains: getMatchingDomains,
    getMatchingUrls: getMatchingUrls,
    ...
    openAIFetchKEPrompt: openAIFetchKEPrompt
  };
