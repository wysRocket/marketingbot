...
import skip_default$1 from "../assets/skip.js";
//#region src/pages/onboarding/views/skip.js
/**
      ...
      <ui-card data-qa="view:skip">
        <section layout="block:center column gap:2">
          <div layout="row center">
            <img src="${skip_default$1}" alt="Skip" layout="size:20" />
          </div>
          ...
          ${chrome.management?.uninstallSelf && html`
            <ui-button
              type="danger"
