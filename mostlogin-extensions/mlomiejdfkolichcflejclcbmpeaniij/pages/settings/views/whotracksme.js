...
//#region src/pages/settings/views/whotracksme.js
/**
        ...
        ${store_default.ready(options, managedConfig) && html`
          <section layout="column gap:4">
            ${options.mode === "default" && html`
              ...
              >
                <div layout="row items:start gap:2 grow" layout@768px="gap:3">
                  <settings-help-image>
                    <img src="${assets_default.pause_assistant}" alt="Browsing Assistant" />
                  </settings-help-image>
                  <settings-option>
                    Browsing Assistant
            ...
            >
              <div layout="row items:start gap:2 grow" layout@768px="gap:3">
                <settings-help-image>
                  <img src="${assets_default.wtm_wheel}" alt="WhoTracks.Me Wheel" />
                </settings-help-image>
                <settings-option>
                  WhoTracks.Me Wheel
                  <span slot="description">
            ...
            ${Options.trackerCount && html`
              ...
              >
                <div layout="row items:start gap:2 grow" layout@768px="gap:3">
                  <settings-help-image>
                    <img src="${assets_default.trackers_count}" alt="Trackers Count" />
                  </settings-help-image>
                  <settings-option>
                    Trackers Count
                    <span slot="description">
            ...
            <settings-managed value="${managedConfig.disableTrackersPreview}">
              ...
              >
                <div layout="row items:start gap:2 grow" layout@768px="gap:3">
                  <settings-help-image>
                    <img src="${assets_default.trackers_preview}" alt="Trackers Preview" />
                  </settings-help-image>
                  <settings-option>
                    Trackers Preview
                    <span slot="description">
              ...
              <ui-action>
                ...
                >
                  <settings-help-image static>
                    <img src="${assets_default.wtm_privacy_report}" alt="WTM Privacy Report" />
                  </settings-help-image>
                  <settings-option>
