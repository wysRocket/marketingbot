...
import contribution_default from "../assets/contribution.js";
//#region src/pages/panel/views/report-confirm.js
/**
...
*/
var report_confirm_default = { render: () => html`
    <template layout="column grow">
      ...
      <panel-container layout="relative">
        <div layout="column items:center gap:3 padding:2:2:4">
          <img src="${contribution_default}" alt="Contribution" layout="size:20 margin:3" />
  ...
  ` };
//#endregion
export { report_confirm_default as default };
